class ChatState {
  ...
  factory ChatState.fromMap(Map<dynamic, dynamic> map) {
    ...
    return ChatState(map["chatId"], map["chatComment"], map["chatSessionStatus"], map["chatRating"], map["isChatting"], map["queuePosition"], agentMapList.map((a) => Agent.fromMap(a as Map<dynamic, dynamic>)).toList(growable: false));
  }
}
